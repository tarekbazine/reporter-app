...
$(document).on('click', '#btn-add-note', function () {
    $('.note-list').append("<li class='todo-list-item'> <label>" + $('#note-input').val() + "</label>" + "<input type='hidden' name='notes[]' value=" + $('#note-input').val() + ">" + "<div class='pull-right action-buttons'><a class='note-item'><em " + "class='fa fa-trash'></em></a></div></li>");
    $('#note-input').val("");
    return false;
});
